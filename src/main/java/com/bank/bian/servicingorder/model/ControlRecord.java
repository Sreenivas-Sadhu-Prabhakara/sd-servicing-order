package com.bank.bian.servicingorder.model;
...
/**
 * The BIAN control record for this service domain: "Servicing Order Procedure".
 *
 ...
 * to its asset type (Servicing Order). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Servicing Order Procedure";
